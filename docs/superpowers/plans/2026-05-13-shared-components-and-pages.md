...
RACK_ENV=test ruby -e "
  ...
  puts \"Has search form: #{body.include?('id=\\\"search-form\\\"')}\"
  puts \"Has genome select: #{body.include?('id=\\\"search-genome\\\"')}\"
  puts \"Has results table: #{body.include?('id=\\\"search-tbody\\\"')}\"
  puts \"Has pagination nav: #{body.include?('id=\\\"page-prev\\\"')}\"
...
RACK_ENV=test ruby -e "
  ...
  body = last_response.body
  puts \"Status: #{last_response.status}\"
  puts \"Has experiment-data JSON island: #{body.include?('id=\\\"experiment-data\\\"')}\"
  puts \"Has SRX038634 heading: #{body.include?('SRX038634')}\"
  puts \"Has Visualize dropdown: #{body.include?('id=\\\"visualize-menu\\\"')}\"
  puts \"Has Analyze dropdown: #{body.include?('id=\\\"analyze-menu\\\"')}\"
  puts \"Has Download dropdown: #{body.include?('id=\\\"download-menu\\\"')}\"
  puts \"Has Link Out dropdown: #{body.include?('id=\\\"linkout-menu\\\"')}\"
