    ...
    columns: [
      {
        ...
        render: function (data, type, row) {
          return (
            "<a title='Open this Info...' target='_blank' style='text-decoration: none' href='/view?id=" +
            data +
            "'>" +
            data +
            "</a>"
      ...
      { title: "<a title='Accession ID'>SRA ID</a>" },
      {
        ...
        render: function (data, type, row) {
          if (data != "-") {
            return (
              "<a title='Open this Info...' target='_blank' style='text-decoration: none' href='https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=" +
              data +
              "'>" +
              data +
              "</a>"
      ...
      {
        title:
          "<a title='Genome assembly (hg19, mm9, rn6, dm3, ce10, sacCer3)'>Genome</a>",
      },
      {
        title:
          "<a title='Track type class name including curated antigen class'>Track type class</a>",
      },
      {
        title:
          "<a title='Track type including curated antigen name'>Track type</a>",
      },
